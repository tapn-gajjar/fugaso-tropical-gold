// 65959681-42a8-43f6-90be-3a788ca0278a
...
function NeutrinoEffect(ctx) {
	...
	this.textures = ['Shape.png','Shape_2.png'];
	this.materials = [1];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]},{materialIndex:0,textureIndices:[1]}];
	this.Xe = 500;

	function Emitter_line_1() {

		var _1 = [], _5 = [], _6, _6i0, _6s0 = [], _4;
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			ctx.T(Xb.Ab, Xb._2);
			ctx.V(_5, 600, 10);
			_6i0=(Bd.Rb<0?0:(Bd.Rb>1?1:Bd.Rb));
			_6i0<0.3?ctx.V(_6s0,0,(_6i0-0)*3.33333):ctx.V(_6s0,1,(_6i0-0.3)*1.42857);
	...
	function Emitter_line_5() {

		var _1 = [], _5 = [], _6 = [], _7, _8, _8i0, _8s0 = [], _4;
		this.pe = [{xe:0,Rc:1,Sc:1,renderStyleIndex:1}];
		this.name = "line_5";
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_8i0<0.3?ctx.V(_8s0,0,(_8i0-0)*3.33333):ctx.V(_8s0,1,(_8i0-0.3)*1.42857);
	...
	this.qd = function(Ld) {
		...
		Ld.pd(new Emitter_line_1());
		Ld.pd(new Emitter_line_3());
		Ld.pd(new Emitter_line_2());
		Ld.pd(new Emitter_line_4());
		Ld.pd(new Emitter_line_5());
	}
